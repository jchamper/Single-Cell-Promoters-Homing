...
good <- c('FBgn0031296', 'FBgn0037549', 'FBgn0037538', 'FBgn0002962',
          'FBgn0283442', 'FBgn0004650', 'FBgn0033921', 'FBgn0262101',
          'FBgn0036809', 'FBgn0003943', 'FBgn0000042', 'FBgn0024177',
          'FBgn0038204', 'FBgn0031074', 'FBgn0031620', 'FBgn0030647',
          'FBgn0039585', 'FBgn0028852', 'FBgn0034837', 'FBgn0034998',
          'FBgn0051477', 'FBgn0034724', 'FBgn0004400', 'FBgn0003401',
          'FBgn0005390', 'FBgn0035861', 'FBgn0052814', 'FBgn0032089',
          'FBgn0030667', 'FBgn0033979')
...
#FigS8 Generate candidate expression plots within a single cell type.####
library(ggplot2)
library(ggpubr)
library(stringr)
...
for (query_cell_type in sig_cell_types) {
  ...
  p <- ggplot(dt, aes(x = group, y = log2(value + 1), color = group)) +
    ...
    scale_x_discrete(labels = c("good" = "High conversion", "bad" = "Low conversion")) +
...
#Fig3F Generate volcano plots for five cell types####
library(data.table)
library(pbapply)
library(ggplot2)
library(ggrepel)
