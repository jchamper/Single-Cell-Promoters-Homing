...
#FDC/MDC no sig / F>M except low conversion####
good <- c('FBgn0031296','FBgn0037549','FBgn0032089','FBgn0003401',
          'FBgn0005390','FBgn0004400','FBgn0262101','FBgn0038204',
          'FBgn0031074','FBgn0031620','FBgn0030647','FBgn0035861',
          'FBgn0028852','FBgn0034998')
...
for (query_cell_type in sig_cell_types) {
  ...
  p <- ggplot(dt, aes(x = group, y = log2(value + 1), color = group)) +
    ...
    scale_x_discrete(labels = c("good" = "Unbiased", "bad" = "Female-biased")) +
...
ggplot(result, aes(x = log2FC, y = neg_log10_p, color = color_group)) +
  ...
  labs(title = "Unbiased - Female Biased Drive Conversion Rate Groups",
